...
def score_result_predictions(
	...
	metadata = getattr(model_bundle, "metadata", {"model_family": "gated_residual"})
	...
	working = merged.copy()
	needs_cat = model_requires_cat_features(model, cat_config) or requires_categorical_inputs(metadata)
