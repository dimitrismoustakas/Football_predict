...
def build_model_kwargs(training_config: dict, num_leagues: int) -> dict:
	...
	return {
		...
		"high_draw_positive_residual_scale": training_config.get("high_draw_positive_residual_scale", 1.0),
		"high_draw_positive_threshold": training_config.get("high_draw_positive_threshold", 0.26),
		"low_draw_negative_residual_scale": training_config.get("low_draw_negative_residual_scale", 1.0),
		"low_draw_negative_threshold": training_config.get("low_draw_negative_threshold", 0.22),
